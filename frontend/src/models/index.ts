export { loginSchema } from './loginSchema/loginSchema'
export type { LoginFormData } from './loginSchema/loginSchema'

export { registerSchema } from './registerSchema/registerSchema'
export type { RegisterFormData } from './registerSchema/registerSchema'
